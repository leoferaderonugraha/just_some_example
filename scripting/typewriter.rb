...
Sekarang kau telah semakin dewasa, ku harap dirimu baik-baik saja;
di sana...;
;
...
;
Walau kita tak pernah bertemu, namun kau pernah mengisi relung hati;
ini...;
;
Akan tetapi, tak ada pertemuan tanpa adanya perpisahan...;
;
Dan ku harap ini bukanlah perpisahan kita, melainkan pertemuan kedua
;
kita dalam pribadi yang lebih dewasa kelak...
;
;
